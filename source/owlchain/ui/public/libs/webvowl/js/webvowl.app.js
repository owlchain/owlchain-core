webvowl.app = function(e) {
    ...
    0: function(e, t, n) { n(310), n(312), e.exports = n(313) },
    6: function(e, t) { e.exports = d3 },
    86: function(e, t, n) {
        function o(e) { return null == e ? void 0 === e ? s : l : (e = Object(e), c && c in e ? i(e) : a(e)) }
        var r = n(87),
            i = n(90),
            a = n(91),
            l = "[object Null]",
    ...
    91: function(e, t) {
        function n(e) { return r.call(e) }
        var o = Object.prototype,
            r = o.toString;
        e.exports = n
    },
    98: function(e, t, n) {
        function o(e) { return "symbol" == typeof e || i(e) && r(e) == a }
        var r = n(86),
            i = n(99),
            a = "[object Symbol]";
        e.exports = o
    ...
    149: function(e, t) {
        function n(e, t) { for (var n = -1, o = null == e ? 0 : e.length, r = Array(o); ++n < o;) r[n] = t(e[n], n, e); return r }
        e.exports = n
    },
    209: function(e, t, n) {
        function o(e) { return null == e ? "" : r(e) }
        var r = n(210);
        e.exports = o
    },
    210: function(e, t, n) {
        function o(e) { if ("string" == typeof e) return e; if (a(e)) return i(e, o) + ""; if (l(e)) return d ? d.call(e) : ""; var t = e + ""; return "0" == t && 1 / e == -s ? "-0" : t }
        var r = n(87),
            i = n(149),
            a = n(107),
            l = n(98),
        ...
        (function(t) {
            e.exports = function() {
                function e(e, t, n) {
                    ...
                    if (e) {
                        var r;
                        try { o = JSON.parse(e), r = !0 } catch (e) { r = !1 }
                ...
                return r.initialize = function() { a.graphContainerSelector(s), a.selectionModules().push(C), a.selectionModules().push(D), a.selectionModules().push(I), a.filterModules().push(S), a.filterModules().push(L), a.filterModules().push(w), a.filterModules().push(A), a.filterModules().push(M), a.filterModules().push(k), a.filterModules().push(N), a.filterModules().push(E), a.filterModules().push(O), a.filterModules().push(x), a.filterModules().push(b), t.select(window).on("resize", o), c.setup(), u.setup(), d.setup(w, A, M, k, N, O), p.setup(I, E, x, b), v.setup(), m.setup(), f.setup(e), h.setup([u, d, p, C, D, v]), g.setup(), y.setup(), a.literalFilter(S), a.filterMenu(d), a.modeMenu(p), a.gravityMenu(u), a.pausedMenu(v), a.pickAndPinModule(I), a.resetMenu(h), a.searchMenu(g), a.ontologyMenu(f), a.navigationMenu(y), a.sidebar(m), i.start(), o() }, r
            }
        }).call(t, n(6))
    },
    314: function(e, t, n) {
        (function(t) {
            e.exports = function(e) {
                ...
                function a(e, t) { return "fill" === t && l(e) }

                function l(e) { var t = e.datum(); return t.backgroundColor && !!t.backgroundColor() }

                function s() { t.selectAll(".hidden-in-export").style("display", "none") }
                ...
                function d() { t.selectAll(".hidden-in-export").style("display", null) }
                ...
                function u() {
                    ...
                    o.each(function(e) { var t = e.id(); for (n = 0; n < s.length; n++) { var o = s[n]; if (o.id === t) { o.pos = [e.x, e.y], e.pinned() && (o.pinned = !0); break } } });
                    for (var p = 0; p < r.length; p++) {
                        var g = r[p].property();
                        for (n = 0; n < c.length; n++)
                            if (u = c[n], u.id === g.id()) { u.pos = [r[p].x, r[p].y], r[p].pinned() && (u.pinned = !0); break }
                    }
                    i.settings = {};
                    var y = e.scaleFactor(),
                        m = e.paused(),
                ...
                }, g.setFilename = function(e) { f = e || "export" }, g.setJsonText = function(e) { h = e }, g
            }
        }).call(t, n(6))
    },
    315: function(e, t, n) {
        (function(t) {
            e.exports = function(e) {
                function n(n, o, r, i) {
                    var a, l;
                    a = t.select(i).append("div").classed("checkboxContainer", !0), l = a.append("input").classed("filterCheckbox", !0).attr("id", o + "FilterCheckbox").attr("type", "checkbox").property("checked", n.enabled()), c.push({ checkbox: l, defaultState: n.enabled() }), l.on("click", function(t) {
                ...
                function o(t, n) {
                    t.setMaxDegreeSetter(function(e) { l.attr("max", e), i(l, Math.min(e, l.property("value"))) }), t.setDegreeGetter(function() { return +l.property("value") }), t.setDegreeSetter(function(e) { i(l, e) });
                    var o, s;
                    o = n.append("div").classed("distanceSliderContainer", !0), l = o.append("input").attr("id", "nodeDegreeDistanceSlider").attr("type", "range").attr("min", 0).attr("step", 1), o.append("label").classed("description", !0).attr("for", "nodeDegreeDistanceSlider").text("Degree of collapsing"), s = o.append("label").classed("value", !0).attr("for", "nodeDegreeDistanceSlider").text(0), l.on("change", function(t) { t !== !0 && (e.update(), a = l.property("value")) }), l.on("input", function() {
                        var e = l.property("value");
                        s.text(e)
                    }), l.on("wheel", r), l.on("focusout", function() { l.property("value") !== a && e.update() })
                }
                ...
                function i(e, t) { e.property("value", t).on("input")() }
                var a, l, s = {},
                    c = [],
                    d = t.select("#filterOption a"),
                    u = t.select("#nodeDegreeFilteringOption");
                return s.getCheckBoxContainer = function() { return c }, s.getDegreeSliderValue = function() { return l.property("value") }, s.setup = function(r, i, a, l, c, p) {
                    var f = t.select("#filterOption");
                    f.on("mouseover", function() {
                        var t = e.options().searchMenu();
                        t.hideSearchEntries()
                    }), d.on("mouseleave", function() { s.highlightForDegreeSlider(!1) }), n(r, "datatype", "Datatype properties", "#datatypeFilteringOption"), n(i, "objectProperty", "Object properties", "#objectPropertyFilteringOption"), n(a, "subclass", "Solitary subclasses", "#subclassFilteringOption"), n(l, "disjoint", "Class disjointness", "#disjointFilteringOption"), n(c, "setoperator", "Set operators", "#setOperatorFilteringOption"), o(p, u)
                }, s.reset = function() {
                ...
                }, s.highlightForDegreeSlider = function(e) { if (arguments.length || (e = !0), d.classed("highlighted", e), u.classed("highlighted", e), d.classed("buttonPulse") === !0 && e === !0) { d.classed("buttonPulse", !1); var t = setTimeout(function() { d.classed("buttonPulse", e), clearTimeout(t) }, 100) } else d.classed("buttonPulse", e) }, s.setCheckBoxValue = function(e, t) { for (var n = 0; n < c.length; n++) { var o = c[n].checkbox.attr("id"); if (o === e) { c[n].checkbox.property("checked", t); break } } }, s.setDegreeSliderValue = function(e) { l.property("value", e) }, s.updateSettings = function() {
                    var e = !0,
                        t = l.property("value");
        ...
        (function(t) {
            e.exports = function(e) {
                function n(n, r, a, l) {
                    ...
                    s.append("label").classed("description", !0).attr("for", r + "DistanceSlider").text(a), c = s.append("label").classed("value", !0).attr("for", r + "DistanceSlider").text(l()), i.push(u), u.on("focusout", function() { e.updateStyle() }), u.on("input", function() {
                ...
                }, r.reset = function() { i.forEach(function(e) { e.property("value", function(e) { return e.distanceFunction() }), e.on("input")() }) }, r
            }
        }).call(t, n(6))
    },
    317: function(e, t, n) {
        (function(t) {
            e.exports = function(e) {
                function n(n, o, r, i, a) {
                    var l, s;
                    return l = t.select(i).append("div").classed("checkboxContainer", !0).datum({ module: n, defaultState: n.enabled() }), s = l.append("input").classed("moduleCheckbox", !0).attr("id", o + "ModuleCheckbox").attr("type", "checkbox").property("checked", n.enabled()), d.push(s), s.on("click", function(t, n) {
                ...
                function i(e) { return e ? s : l }
                var a, l = { text: "Multicolor", type: "same" },
                    s = { text: "Multicolor", type: "gradient" },
                    c = {},
                    d = [];
                return c.colorModeState = function(e) { return arguments.length ? (a.datum().active = e, c) : a.datum().active }, c.getCheckBoxContainer = function() { return d }, c.colorModeSwitch = function() { return a }, c.setup = function(r, i, l, s) {
                ...
                }, c.setCheckBoxValue = function(e, t) { for (var n = 0; n < d.length; n++) { var o = d[n].attr("id"); if (o === e) { d[n].property("checked", t); break } } }, c.setColorSwitchState = function(e) { c.colorModeState(!e) }, c.updateSettings = function() {
                    var e = !0;
                    d.forEach(function(t) { t.on("click")(t.datum(), e) }), a.on("click")(e)
                }, c
            }
        }).call(t, n(6))
    },
    318: function(e, t, n) {
        (function(t) {
            ...
            e.exports = function(e) {
                ...
                function r() { t.selectAll("#optionsMenu > li > a").attr("href", location.hash || "#") }
                ...
                function s() {
                    ...
                    }).on("click", function() { v() }), t.select("#iri-converter-form").on("submit", function() {
                ...
                function d(n) { var o = E[n]; if (o) return h(), x(o, n), g(!0), O === !0 && w.emptyGraphError(), void y(); var r = t.select("#file-converter-input").property("files")[0]; return !r || n && n !== r.name ? (x(void 0, void 0), g(!1, void 0, 'No cached version of "' + n + '" was found. Please reupload the file.'), void e.clearGraphData()) : (n = r.name, void(n.match(/\.json$/) ? (h(), u(r, n)) : p(r, n, !0))) }

                function u(e, t) {
                    var n = new FileReader;
                    n.readAsText(e), n.onload = function() { h(), f(n.result, t), g(!0), O === !0 && w.emptyGraphError(), y() }
                }
                ...
                function p(n, o, r) {
                    ...
                    l.open("POST", "convert", !0), l.onload = function() { i.property("disabled", !1), 200 === l.status ? (f(l.responseText, o), E[o] = l.responseText) : (x(void 0, void 0), g(!1, l.responseText), y(), e.clearGraphData()), y(), O === !0 && r === !0 && (console.log("Failed to convert the file"), E[o] = void 0, w.notValidJsonFile()) }, l.send(a)
                }
                ...
                function v() {
                    function e() { n.style("display", void 0), clearTimeout(m), t.select(window).on("click", void 0).on("keydown", void 0), n.on("mouseover", void 0) }
                    var n = t.select("#select .toolTipMenu");
                    n.on("click", function() { t.event.stopPropagation() }).on("keydown", function() { t.event.stopPropagation() }), n.style("display", "block"), clearTimeout(m), m = setTimeout(function() { e() }, 3e3), t.select(window).on("click", function() { e() }).on("keydown", function() { e() }), n.on("mouseover", function() { e() })
                }

                function h() { C.classed("hidden", !0), S.classed("hidden", !1) }
                ...
                var m, b, x, w = {},
                    ...
                    O = !1,
                    E = {};
                return String.prototype.beginsWith = function(e) { return 0 === this.indexOf(e) }, w.setup = function(o) {
                    x = o;
                    ...
                    var i = t.select("#error-description-button").datum({ open: !1 });
    ...
    319: function(e, t, n) {
        function o(e) { return e = r(e), e && l.test(e) ? e.replace(a, i) : e }
        var r = n(209),
            i = n(320),
    ...
    322: function(e, t, n) {
        (function(t) {
            e.exports = function(e) {
                ...
                function o() { i.classed("paused", function(e) { return e.paused }) }

                function r() { i.datum().paused ? i.text("Resume") : i.text("Pause") }
                var i, a = {};
                return a.setup = function() {
                    ...
                    o.on("mouseover", function() {
                        var t = e.options().searchMenu();
                        t.hideSearchEntries()
                    }), i = t.select("#pause-button").datum({ paused: !1 }).on("click", function(t) { e.paused(!t.paused), t.paused = !t.paused, n(), i.classed("highlighted", t.paused), e.options().navigationMenu().updateVisibilityStatus() }), n()
                }, a.setPauseValue = function(t) { i.datum().paused = t, e.paused(t), i.classed("highlighted", t), n() }, a.reset = function() { a.setPauseValue(!1) }, a
            }
        }).call(t, n(6))
    },
    323: function(e, t, n) {
        (function(t) {
            e.exports = function(e) {
                function n() { i.classDistance(a.classDistance()), i.datatypeDistance(a.datatypeDistance()), i.charge(a.charge()), i.gravity(a.gravity()), i.linkStrength(a.linkStrength()), e.reset(), o.forEach(function(e) { e.reset() }), e.updateStyle() }
                var o, r = {},
                    i = e.graphOptions(),
                    a = webvowl.options();
    ...
    324: function(e, t, n) {
        (function(t) {
            e.exports = function(e) {
                ...
                function o() { g.showSearchEntries() }

                function r() { w ? g.hideSearchEntries() : g.showSearchEntries() }

                function i(e) { var t = /^(https?|ftp):\/\/([a-zA-Z0-9.-]+(:[a-zA-Z0-9.&%$-]+)*@)*((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]?)(\.(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9]?[0-9])){3}|([a-zA-Z0-9-]+\.)*[a-zA-Z0-9-]+\.(com|edu|gov|int|mil|net|org|biz|arpa|info|name|pro|aero|coop|museum|[a-zA-Z]{2}))(:[0-9]+)*(\/($|[a-zA-Z0-9.,?'\\+&%$#=~_-]+))*$/; return t.test(e) }
                ...
                function a() {
                    ...
                    var o, r = u.node().children,
                        ...
                        l = 0,
                        s = -1;
                    for (o = 0; o < a; o++) { var c = r[o].getAttribute("class"); "dbEntrySelected" === c && (s = o) }
                ...
                var d, u, p, f, v, h, g = {},
                    ...
                    x = !0,
                    w = !1;
                return String.prototype.beginsWith = function(e) { return 0 === this.indexOf(e) }, g.requestDictionaryUpdate = function() {
                    x = !0;
                    for (var e = u.node().children, t = e.length, n = 0; n < t; n++) e[0].remove();
                    d.node().value = ""
                }, g.setup = function() { y = [], d = t.select("#search-input-text"), u = t.select("#searchEntryContainer"), d.on("input", s), d.on("keydown", a), d.on("click", r), d.on("mouseover", o) }, g.hideSearchEntries = function() { u.style("display", "none"), w = !1 }, g.showSearchEntries = function() { u.style("display", "block"), w = !0 }, g.clearText = function() { d.node().value = ""; for (var e = u.node().children, t = e.length, n = 0; n < t; n++) e[0].remove() }, g
            }
        }).call(t, n(6))
    },
    325: function(e, t, n) {
        (function(t) {
            e.exports = function(e) {
                    ...
                    u.on("mouseover", function() {
                        ...
                        if (1 !== c[0]) {
                            ...
                            for (c[o] = 1, s[o].style.display = "block", e = l + 1; e < c.length; e++) {
                                if (c[e] = 0, s[e].style.display = "block", t = s[o].getBoundingClientRect().top, n = s[e].getBoundingClientRect().top, t !== n) { s[e].style.display = "none", c[e] = 0; break }
                                c[e] = 1
                            }
                            r();
                            var d = i(),
                        ...
                        if (1 !== c[c.length - 1]) {
                            ...
                            for (c[t] = 1, s[t].style.display = "block", e = n - 1; e >= 0; e--) {
                                ...
                                if (o !== l) { s[e].style.display = "none", c[e] = 0; break }
                                c[e] = 1
                            }
                            r();
                            var d = i();
                ...
                function o() { c[0] = 1, s[0].style.display = "block" }
                ...
                function a() { 1 !== c[c.length - 1] ? p.classed("highlighted", !0) : p.classed("highlighted", !1), 1 !== c[0] ? u.classed("highlighted", !0) : u.classed("highlighted", !1) }
                var l = {},
                    s = [],
                    c = [],
                ...
                return l.setup = function() { var e, t = d.node().children; for (e = 0; e < t.length; e++) s.push(t[e]); for (n(), e = 0; e < s.length - 2; e++) s[e].style.display = "block", c[e] = 1 }, l.updateVisibilityStatus = function() {
                    var e, t = c.indexOf(1);
                    t === -1 && (o(), t = c.indexOf(1));
                    ...
                    for (d === -1 && u === -1 && (o(), d = c.indexOf(1), u = c.lastIndexOf(1)), e = d + 1; e < s.length - 2; e++) {
                        if (s[e].style.display = "block", l = s[d].getBoundingClientRect().top, n = s[e].getBoundingClientRect().top, l !== n) { s[e].style.display = "none", c[e] = 0; break }
                        c[e] = 1
                    }
                    r();
                    var p, f = i();
                    if (f || 0 !== d || (p = c.lastIndexOf(1), p !== -1 && (c[p] = 0, s[p].style.display = "none")), 0 !== d || u !== c.length) {
                        if (u = c.lastIndexOf(1), u >= 1) {
                            ...
                            for (e = u - 1; e >= 0; e--) {
                                if (c[e] = 0, s[e].style.display = "block", l = s[u].getBoundingClientRect().top, n = s[e].getBoundingClientRect().top, l !== n) { s[e].style.display = "none", c[e] = 0; break }
                                c[e] = 1
                            }
                        }
    ...
    326: function(e, t, n) {
        (function(t) {
            e.exports = function(e) {
                function n() {
                    function e(e) { e.classed("hidden", !0) }

                    function n(e) { e.classed("hidden", !1) }
                ...
                function o(n) {
                    n = n || [], n.sort(function(e, t) { return e === webvowl.util.constants().LANG_IRIBASED ? -1 : t === webvowl.util.constants().LANG_IRIBASED ? 1 : e === webvowl.util.constants().LANG_UNDEFINED ? -1 : t === webvowl.util.constants().LANG_UNDEFINED ? 1 : e.localeCompare(t) });
                    var o = t.select("#language").on("change", function() { e.language(t.event.target.value), i(), C.updateSelectionInformation(k) });
                    o.selectAll("option").remove(), o.selectAll("option").data(n).enter().append("option").attr("value", function(e) { return e }).text(function(e) { return e }), r(o, n, "en") || r(o, n, webvowl.util.constants().LANG_UNDEFINED) || r(o, n, webvowl.util.constants().LANG_IRIBASED)
                }

                function r(t, n, o) { var r = n.indexOf(o); return r >= 0 && (t.property("selectedIndex", r), e.language(o), !0) }
                ...
                function s(e, n) {
                    ...
                    e.selectAll(".annotation").remove(), e.selectAll(".annotation").data(o).enter().append("p").classed("annotation", !0).classed("statisticDetails", !0).text(function(e) { return e.identifier + ":" }).append("span").each(function(e) { v(t.select(this), e.value, "iri" === e.type ? e.value : void 0) })
                }

                function c() { d(!1, !1, !0) }

                function d(e, n, o) { t.select("#classSelectionInformation").classed("hidden", !e), t.select("#propertySelectionInformation").classed("hidden", !n), t.select("#noSelectionInformation").classed("hidden", !o) }
                ...
                function y(e) {
                    ...
                    void 0 !== e.disjointWith() ? (o.selectAll("*").remove(), e.disjointWith().forEach(function(e, t) { t > 0 && o.append("span").text(", "), v(o, e.labelForCurrentLanguage(), e.iri()) }), r.classed("hidden", !1)) : r.classed("hidden", !0), h(e.attributes(), t.select("#classAttributes")), x(t.select("#nodeDescription"), e.descriptionForCurrentLanguage()), x(t.select("#nodeComment"), e.commentForCurrentLanguage()), s(t.select("#classSelectionInformation"), e.annotations())
                }
                ...
                function b(e, n) {
                    ...
                    n && n.length ? (e.selectAll("*").remove(), n.forEach(function(t, n) { n > 0 && e.append("span").text(", "), v(e, t.labelForCurrentLanguage(), t.iri()) }), o.classed("hidden", !1)) : o.classed("hidden", !0)
                }
                ...
                return C.setup = function() { n() }, C.clearOntologyInformation = function() {
                ...
                }, C.updateOntologyInformation = function(e, t) { e = e || {}, w = e.header || {}, i(), a(e.metrics, t), l(w.other), C.updateSelectionInformation(void 0), o(w.languages) }, C.updateSelectionInformation = function(e) {
